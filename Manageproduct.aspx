...
<div class="jumbotron text-center">
  ...
  <form runat="server">
  <div class="container">
  <div class="col-sm-3"> <h3> Wel come Admin  </h3></div>
   <div class="col-sm-6">
   <div class="panel panel-primary">
   <div class="panel-heading">Add New Items</div></div>
   ...
   <label>Flavour </label>
       <asp:TextBox ID="txtflavour"  CssClass="form-control" runat="server"  placeholder="New Flavour "></asp:TextBox>
    ...
    <label>Quantity</label>
      ...
      <div class="form-group">
   <label>Weight-  </label>
       <asp:TextBox ID="txtweight"  CssClass="form-control" runat="server"  placeholder="Weight"></asp:TextBox>
